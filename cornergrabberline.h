#ifndef CORNERGRABBERLINE_H
#define CORNERGRABBERLINE_H
...
class CornerGrabberLine : public QGraphicsItem
{

public:
    explicit CornerGrabberLine(QGraphicsItem *parent = 0,  int corner=0);
