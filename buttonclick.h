...
void MainWindow::sekilButtonIconSlot(){
    ...
    else  if(DiagramItem::DiagramType::Pramit==mySekilType)    {sekilButton->setIcon(QIcon(":icons/pramit.svg")); }
    else  if(DiagramItem::DiagramType::Kure==mySekilType)    {sekilButton->setIcon(QIcon(":icons/kure.svg")); }
...
void MainWindow::infoButtonClick(){
    ...
    msgBox.setWindowTitle("E-Tahta 1.7.0");
