    ...
    connect(_screenbtn, &QPushButton::clicked, [=]() {
       ...
       /// qDebug()<<"sayı:"<<pageList.length();
        ...
        for(int i=0;i<pageList.length();i++)
        {
            ...
            pageList[i]->setObjectName("_screenbtn");

            pageList[i]->setStyleSheet("QWidget#_screenbtn{"
        ...
        _screenbtn->setObjectName("_screenbtn");


        _screenbtn->setStyleSheet("QWidget#_screenbtn{"
                                  "border: 0.5px solid rgb(62, 140, 220,20);"
                                  "border-radius: 5px;"
...
void MainWindow::silSayfaButtonClick(){
 ///qDebug()<<"sil sayfa-0"<<sceneSayfaActiveNumber;
   ...
   /// if(sceneSayfaNumber>0)sceneSayfaNumber--;
    ...
    pageList[sceneSayfaActiveNumber]->setObjectName("_screenbtn");

    pageList[sceneSayfaActiveNumber]->setStyleSheet("QWidget#_screenbtn{"
                          "border: 0.5px solid rgb(62, 140, 220,20);"
                          "border-radius: 5px;"
                          "background-color:rgb(255,0,0,100);"
                          "}");
