...
{
public:
     enum DiagramType {NoType, Kup,Pramit,Kure,Silindir,Pergel,Cetvel,Gonye,Iletki,Cizgi,Ok,CiftOk,Ucgen,Dortgen,Cember,
                       Baklava,ParalelKenar,Yamuk,Besgen,
                       Altigen,Sekizgen,DikUcgen,GuzelYazi,Muzik,CizgiliSayfa,Kalem,Resim,Copy,DrawPath,DrawPoligon};
