...
if(_outterborderColor!=Qt::red&&_corner==1) _outterborderColor=QColor(0,255,0);
if(_outterborderColor!=Qt::red&&_corner==2) _outterborderColor=QColor(255,255,0);
if(_outterborderColor!=Qt::red&&_corner==3) _outterborderColor=QColor(0,0,255);
